...
class CORSTHTTPRequestHandler(SimpleHTTPRequestHandler):
...
def run(
    ...
    handler_class=CORSTHTTPRequestHandler,
    port=8000,
    directory=None,
):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, help="Port to serve on", default=8888)
